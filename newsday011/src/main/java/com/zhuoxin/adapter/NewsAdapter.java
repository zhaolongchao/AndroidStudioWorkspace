...
public class NewsAdapter extends BaseAdapter1<TodayNews> {
    //创建图片加载对象
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TodayNews tn=baseData.get(i);
        holder.tvTitle.setText(tn.getTitle());//设置标题
        holder.tvSummary.setText(tn.getDigest());//设置摘要
        String url=tn.getImgsrc();//获得图片链接地址
